...
- [Segments](./segments/index.md)
  - [ai_host](./segments/ai_host.md)
  - [ai_status](./segments/ai_status.md)
  - [anaconda](./segments/anaconda.md)
  - [aws](./segments/aws.md)
  - [background_jobs](./segments/background_jobs.md)
  - [command_execution_time](./segments/command_execution_time.md)
  - [context](./segments/context.md)
  - [dir](./segments/dir.md)
  - [docker_context](./segments/docker_context.md)
  - [fnm](./segments/fnm.md)
  - [jj](./segments/jj.md)
...
- [Crate layout](./arch/crates.md)
- [Render pipeline](./arch/render.md)
- [Security model](./arch/security.md)
